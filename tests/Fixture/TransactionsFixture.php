...
class TransactionsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'transaction_amount' => ['type' => 'float', 'length' => null, 'precision' => null, 'unsigned' => false, 'null' => false, 'default' => '0', 'comment' => ''],
    ...
    public $records = [
        [
            ...
            'transaction_date' => '2017-05-14 04:03:46',
            'created' => '2017-05-14 04:03:46',
            'modified' => '2017-05-14 04:03:46'
        ],
    ];
}
