...
/**
 * TransactionsCategoriesFixture
 *
 */
class TransactionsCategoriesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['transaction_id', 'category_id'], 'length' => []],
            'category_key' => ['type' => 'foreign', 'columns' => ['category_id'], 'references' => ['categories', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'transaction_key' => ['type' => 'foreign', 'columns' => ['transaction_id'], 'references' => ['transactions', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            'transaction_id' => 1,
            'category_id' => 1,
            'created' => '2017-05-14 04:03:56',
            'modified' => '2017-05-14 04:03:56'
        ],
    ];
}
